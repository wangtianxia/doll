<template>
  <div class="createClassContent">
    ...
    <div>
     娃娃的ID:
      <el-input class="dollId" v-model="dollId" placeholder="请输入娃娃Id"></el-input>
    </div>
    <div>
     娃娃名称:
    ...
    <div>
      抓取价格:
      <el-input v-model="grabPrice" placeholder="请输入娃娃价格"></el-input>
    </div>
    <div>
     回购价格:
      <el-input v-model="backPrice" placeholder="请输入娃娃回购价格"></el-input>
    </div>
    <div class="sendWay">
...
<script>
  import {addDoll} from "../server/getData.js";
  export default {
    data(){
      return {
        dollId: '',
